/**
 * React binding for core/timer.ts. Reused from the wizard-timer project.
 *
...
export interface UseTimerOptions {
  /** Namespace for localStorage. Each timer in the app gets its own. */
  storageKey: string;
...
export interface Timer {
  ...
  /** Remaining time as `m:ss`, ready to render. */
...
export function useTimer(options: UseTimerOptions): Timer {
  ...
  // page load does not fire onFinish — nobody wants a gong for a session that
  // ended yesterday.
